...
SELECT CURDATE();      -- 2021-07-01
SELECT CURDATE() + 0;  -- 20210701
...
-- Add/Sub Day
-- ex) '2021-07-15'
FROM_UNIXTIME(UNIX_TIMESTAMP(DAYS_ADD(CAST(colName AS TIMESTAMP), +5)), 'yyyyMMdd') AS column1  -- '20210720'
FROM_UNIXTIME(UNIX_TIMESTAMP(DAYS_ADD(CAST(colName AS TIMESTAMP), -5)), 'yyyyMMdd') AS column1  -- '20210710'
